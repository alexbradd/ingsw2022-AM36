...
public abstract class Phase {
     ...
     * @throws IllegalArgumentException if any parameter is null
     */
    public Phase updateEntrance(Player player, Function<Entrance, Entrance> update) throws InvalidPhaseUpdateException {
        throw new UnsupportedOperationException();
    }
     ...
     * @throws IllegalArgumentException if any parameter is null
     */
    public Phase updateHall(Player player, Function<Hall, Hall> update) throws InvalidPhaseUpdateException {
        throw new UnsupportedOperationException();
    }
     ...
     * @throws UnsupportedOperationException if this operation is not supported by the current phase of the game
     * @throws IllegalArgumentException      if any parameter is null
     * @throws InvalidPhaseUpdateException   if the additional information "args" is either missing or incorrect
     ...
     */
    public Phase playCharacter(Player player, CharacterType character, CharacterStep[] steps) throws InvalidPhaseUpdateException {
        throw new UnsupportedOperationException();
    }
